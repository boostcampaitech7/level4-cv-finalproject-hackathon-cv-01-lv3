...
import numpy as np
from sampling import read_frames_cv2, load_video
# 01.18, deamin
...
class InternVideo2_VideoChat2_Dataset(Dataset): 
    ...
    def __getitem__(self, index):
        ...
        # 동영상 읽기
        frames = load_video(video_path, num_segments=self.num_frames, return_msg=False, resolution=224, hd_num=6)
...
class InternVideo2_VideoChat2_Image_Dataset(Dataset): 
    ...
    def _prepare_frames(self):
        ...
        for label in self.labels:
            ...
            # 동영상 읽기
            frames, frame_indices = load_video(video_path, num_sampling=self.num_sampling, return_msg=False, resolution=224, hd_num=6)
